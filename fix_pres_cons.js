...
function updateChat(path, role, sender, inputId) {
    if (!fs.existsSync(path)) return;
    let content = fs.readFileSync(path, 'utf8');
    
    let startIndex = content.indexOf("{/* TAB MESSAGES");
    if (startIndex === -1) startIndex = content.indexOf("{/* TAB BOARD MESSAGES");
...
updateChat('src/pages/dashboard/ConseillerDashboard.tsx', 'conseiller', 'Conseiller', 'consChatMsg');
updateChat('src/pages/dashboard/PresidentDashboard.tsx', 'president', 'Président', 'presChatMsg');
